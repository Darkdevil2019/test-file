...
public class CameraHandler {
    ...
    public void initializeCamera(ImageClassifierActivity imageClassifierActivity, Handler mBackgroundHandler, ImageClassifierActivity imageClassifierActivity1) {
    }
